...
class FlowField:
    ...
    def calculate_wake(self, no_wake=False, points=None, track_n_upstream_wakes=False, sim_time=None, look_ahead=False, propagate_wind_speed=None, visualize=False, first_x=None):
        """
